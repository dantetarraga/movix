...
import { Button, FormControlLabel, Grid, Paper, TextField, Typography } from '@mui/material';
...
const Login = () => {
    ...
    const notify = () => toast.success('Contraseña actualizada. Por favor, verifica tu correo electronico.', {
        position: "top-right",
        autoClose: 5000,
    ...
    const handleLogin = (event) => {
        ...
        console.log("Login...");
        axios.post('http://localhost:3000/login', { emailOrUsername: emailOrUsername, password: password },
        ...
        <div className='login'>
            ...
            >
                <Grid item xs={10} sm={8} md={6} lg={4} className='grid__form form'>
                    <Paper elevation={3} style={{ padding: '60px' }} className='form__paper paper'>
            ...
            <PasswordResetDialog open={openDialog} onClose={handleCloseDialog} passwordReset={handlePasswordReset} />
